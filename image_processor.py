...
def place_text_in_spaces(image_path, translation_texts, output_path="output_with_translation.png"):
    ...
    for i, space in enumerate(spaces):
        if i < len(translation_texts):
            ...
            # Draw the translated text in red color for visibility
...
if __name__ == "__main__":
    ...
    # Process an image
    # result_path = place_text_in_spaces("input_image.png", example_translations)
    # print(f"Processed image saved to {result_path}")
    
    # Process a PDF page
    # pdf_result = process_pdf_page_for_translation("input.pdf", 0, example_translations)
    # print(f"Processed PDF saved to {pdf_result}")